...
public class InformalTurkishAnalysisTest extends AnalyzerTestBase {
  ...
  public void testProgressiveDeformation() {
    ...
    t.expectSingle("yazıyom", matchesTailLex("Verb + Prog1Informal + A1sg"));
    t.expectSingle("yazıyon", matchesTailLex("Verb + Prog1Informal + A2sg"));
    t.expectSingle("yazıyosun", matchesTailLex("Verb + Prog1Informal + A2sg"));
    t.expectSingle("yazıyo", matchesTailLex("Verb + Prog1Informal + A3sg"));
    t.expectSingle("yazıyoz", matchesTailLex("Verb + Prog1Informal + A1pl"));
    t.expectSingle("yazıyosunuz", matchesTailLex("Verb + Prog1Informal + A2pl"));
    t.expectSingle("yazıyonuz", matchesTailLex("Verb + Prog1Informal + A2pl"));
    t.expectSingle("yazıyolar", matchesTailLex("Verb + Prog1Informal + A3pl"));

    t.expectSingle("yazıyosa", matchesTailLex("Verb + Prog1Informal + Cond + A3sg"));
    t.expectSingle("yazıyomuş", matchesTailLex("Verb + Prog1Informal + Narr + A3sg"));

    t = getTester("bilmek [A:Aorist_I]");
    t.expectSingle("biliyosun", matchesTailLex("Verb + Prog1Informal + A2sg"));
  ...
  public void testProgressiveDeformation2() {
    ...
    t.expectSingle("okuyom", matchesTailLex("Verb + Prog1Informal + A1sg"));
    t.expectSingle("okuyon", matchesTailLex("Verb + Prog1Informal + A2sg"));
    t.expectSingle("okuyosun", matchesTailLex("Verb + Prog1Informal + A2sg"));
  }
  ...
  public void progressiveDeformationDrop() {
    ...
    t.expectSingle("arıyom", matchesTailLex("Verb + Prog1Informal + A1sg"));
    t.expectSingle("arıyo", matchesTailLex("Verb + Prog1Informal + A3sg"));
    ...
    t.expectSingle("yürüyom", matchesTailLex("Verb + Prog1Informal + A1sg"));
    t.expectSingle("yürüyo", matchesTailLex("Verb + Prog1Informal + A3sg"));

    t = getTester("denemek");

    t.expectSingle("deniyom", matchesTailLex("Verb + Prog1Informal + A1sg"));
    t.expectSingle("deniyo", matchesTailLex("Verb + Prog1Informal + A3sg"));
  }
  ...
  public void progressiveDeformationNegative() {
    ...
    t.expectSingle("yazmıyom", matchesTailLex("Verb + Neg + Prog1Informal + A1sg"));
  ...
  public void futureDeformation() {
    ...
    t.expectAny("yazacam", matchesTailLex("Verb + FutInformal + A1sg"));
    t.expectAny("yazcam", matchesTailLex("Verb + FutInformal + A1sg"));
