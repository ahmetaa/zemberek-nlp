...
public class AddNewDictionaryItem {
  ...
  public AddNewDictionaryItem(_TurkishMorphology morphology) {
  ...
  void test(String input, DictionaryItem newItem) throws IOException {
    ...
    _WordAnalysis before = morphology.analyze(input);
    ...
    _WordAnalysis after = morphology.analyze(input);
    System.out.println("Parses for " + input + " after adding " + newItem);
    printResults(after);
  }

  private void printResults(_WordAnalysis results) {
    int i = 1;
