...
public class TurkishAlphabetTest {
  ...
  public void getAsciiEquivalentLetter() {
    TurkishAlphabet alphabet = TurkishAlphabet.INSTANCE;
    Assert
        .assertEquals(alphabet.getAsciiEquivalentLetter(TurkishAlphabet.L_a), TurkishAlphabet.L_a);
    Assert
        .assertEquals(alphabet.getAsciiEquivalentLetter(TurkishAlphabet.L_x), TurkishAlphabet.L_x);
    Assert
        .assertEquals(alphabet.getAsciiEquivalentLetter(TurkishAlphabet.L_cc), TurkishAlphabet.L_c);
    Assert
        .assertEquals(alphabet.getAsciiEquivalentLetter(TurkishAlphabet.L_ii), TurkishAlphabet.L_i);
    Assert
        .assertEquals(alphabet.getAsciiEquivalentLetter(TurkishAlphabet.L_ss), TurkishAlphabet.L_s);
    Assert
        .assertEquals(alphabet.getAsciiEquivalentLetter(TurkishAlphabet.L_gg), TurkishAlphabet.L_g);
    Assert
        .assertEquals(alphabet.getAsciiEquivalentLetter(TurkishAlphabet.L_oo), TurkishAlphabet.L_o);
    Assert
        .assertEquals(alphabet.getAsciiEquivalentLetter(TurkishAlphabet.L_uu), TurkishAlphabet.L_u);
  }
  ...
  public void getasciiEquivalentLetterByChar() {
    ...
    Assert
        .assertEquals(alphabet.getAsciEquivalentLetter(TurkishAlphabet.C_cc), TurkishAlphabet.L_c);
    Assert
        .assertEquals(alphabet.getAsciEquivalentLetter(TurkishAlphabet.C_ii), TurkishAlphabet.L_i);
    Assert
        .assertEquals(alphabet.getAsciEquivalentLetter(TurkishAlphabet.C_ss), TurkishAlphabet.L_s);
    Assert
        .assertEquals(alphabet.getAsciEquivalentLetter(TurkishAlphabet.C_gg), TurkishAlphabet.L_g);
    Assert
        .assertEquals(alphabet.getAsciEquivalentLetter(TurkishAlphabet.C_oo), TurkishAlphabet.L_o);
    Assert
        .assertEquals(alphabet.getAsciEquivalentLetter(TurkishAlphabet.C_uu), TurkishAlphabet.L_u);
  }
