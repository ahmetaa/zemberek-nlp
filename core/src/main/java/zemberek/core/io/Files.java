...
public class Files {
  ...
  /**
   * checks if input file contains UTF-8 BOM information. note that it is not required that UTF-8
   * files carries this information.
   *
  ...
  /**
   * merges files into a single file. if the target file already exist, it appends it. if target
