...
public final class SimpleTextReader implements AutoCloseable {
   ...
   * @throws java.io.IOException if a porblem occurs while accessing file.
   */
  public static SimpleTextReader trimmingReader(InputStream is, String encoding)
      throws IOException {
   ...
   * @throws java.io.IOException if a porblem occurs while accessing file.
   */
  public static LineIterator trimmingLineIterator(InputStream is, String encoding)
      throws IOException {
    return new Builder(is).encoding(encoding).trim().ignoreWhiteSpaceLines().build()
        .getLineIterator();
  }
   ...
   * @throws java.io.IOException if a porblem occurs while accessing file.
   */
  public static IterableLineReader trimmingIterableLineReader(InputStream is, String encoding)
      throws IOException {
    return new Builder(is).encoding(encoding).trim().ignoreWhiteSpaceLines().build()
        .getIterableReader();
  }
