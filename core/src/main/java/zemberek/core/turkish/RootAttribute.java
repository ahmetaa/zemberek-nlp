...
public enum RootAttribute implements StringEnum {
    ...
    // This attribute is used for formatting a word. If this is used, when a suffix is added to a
    // Proper noun, no single quote is used as a separator. Such as "Türkçenin"
    NoQuote,
    ...
    // Some compound nouns cannot be used in root form. For example zeytinyağı -> zeytinyağ.
    // For preventing false positives this attribute is added to the zeytinyağ form of the word.
    // So that representing state cannot be terminal.
