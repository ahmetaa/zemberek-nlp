...
public class TurkishAlphabet {
  ...
  public static final TurkicLetter L_cc = builder(C_cc, 4).notInAscii().voiceless()
  ...
  public static final TurkicLetter L_gg = builder(C_gg, 9).continuant().notInAscii()
      .similarAscii('g').build();
  public static final TurkicLetter L_h = builder('h', 10).continuant().voiceless().build();
  public static final TurkicLetter L_ii = builder(C_ii, 11).vowel().notInAscii().similarAscii('i')
      .build();
  ...
  public static final TurkicLetter L_oo = builder(C_oo, 19).vowel().frontalVowel().roundedVowel()
  ...
  public static final TurkicLetter L_ss = builder(C_ss, 23).continuant().notInAscii().voiceless()
  ...
  public static final TurkicLetter L_uu = builder(C_uu, 26).vowel().roundedVowel().frontalVowel()
  ...
  public static final TurkicLetter L_ac = builder(a_CIRC, 33).vowel().similarAscii('a').notInAscii()
      .build();
  public static final TurkicLetter L_ic = builder(i_CIRC, 34).vowel().frontalVowel()
      .similarAscii('i').notInAscii().build();
  public static final TurkicLetter L_uc = builder(u_CIRC, 35).vowel().frontalVowel()
