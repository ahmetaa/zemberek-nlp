...
class LanguageIdServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Detect = channel.unary_unary(
        ...
        request_serializer=language__id__pb2.DetectRequest.SerializeToString,
        response_deserializer=language__id__pb2.DetectResponse.FromString,
        )
...
def add_LanguageIdServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'Detect': grpc.unary_unary_rpc_method_handler(
          servicer.Detect,
          request_deserializer=language__id__pb2.DetectRequest.FromString,
          response_serializer=language__id__pb2.DetectResponse.SerializeToString,
      ),
