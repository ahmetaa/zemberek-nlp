...
public class TurkishSuffixesTest {
  ...
  public void testCompounds() {
    ...
    tester.assertHasParses("zeytinyağcık", "zeytinyağım", "zeytinyağına", "zeytinyağlılar",
        "zeytinyağlılarım", "zeytinyağı", "zeytinyağcığa", "zeytinyağlarım");
  ...
  public void testPassive() {
    ...
    tester.assertHasParses("yaptırıl", "yaptırtıl", "yaptırttırıl", "aratıl", "arattırıl",
        "arattırtıl");
  }
  ...
  public void testProgressive() {
    // Noun-Noun
    Tester tester = new Tester("aramak", "gelmek");
    tester.assertHasParses("arıyor", "aramıyor", "geliyor", "gelmiyor", "arıyordu", "arıyorlardı",
        "gelmiyorlarsa");
  ...
  public void testPast() {
    Tester tester = new Tester("aramak", "gitmek [A:Voicing, Aorist_A]");
    tester
        .assertHasParses("aradı", "gitti", "gittik", "gittiyse", "gittim", "gittiniz", "gittiydim");
  ...
  public void testImp() {
    Tester tester = new Tester("aramak", "gitmek [A:Voicing, Aorist_A]", "hapsetmek [A:Voicing]",
        "buyurmak [A:LastVowelDrop]");
    tester.assertHasParses("ara", "arayın", "git", "gitme", "gidiniz", "gitsene", "gitsenize",
        "aramayacak", "aramasın", "gitmesin", "arasınlar", "gitmesinler", "buyrun");
  ...
  public void testFuture() {
    Tester tester = new Tester("aramak", "gitmek [A:Voicing, Aorist_A]");
    tester.assertHasParses("arayacak", "arayacağız", "aramayacak", "aratacak", "arayacaklar",
        "arayacaktık");
  ...
  public void testNess() {
    Tester tester = new Tester("elma", "mavi [P:Adj]");
    tester.assertHasParses("elmacıktı", "elmalık", "elmalığı", "elmalıktı", "elmalığa", "mavilik",
        "maviliği", "mavilikti");
  ...
  public void verbVowelDrop() {
    ...
    tester.assertHasParses("kavurdu", "kavuracağız", "kavurur", "kavuruyor", "kavur", "kavrul",
        "kavrulma", "kavurma", "kavrulacağız", "kavrulmayıver", "kavurtacağız");
  ...
  public void ability() {
    Tester tester = new Tester("aramak", "gitmek [A:Voicing, Aorist_A]");
    // abil
    tester.assertHasParses("arayabil", "arayabilir", "arayabilecek", "gidebil", "gidebilecek",
        "gidebiliyor");
    // a
    tester.assertHasParses("arayamıyorum", "arayamaya", "arayamasın", "arayamamaktan", "gidemese");
    tester.assertHasParses("arayamam", "arayamazsın", "arayamayız", "arayama", "arayamayabilir",
        "gideme", "gidemeyebilir");
  }

  @Test
  public void asif() {
    Tester tester = new Tester("aramak", "gitmek [A:Voicing, Aorist_A]");
    tester.assertHasParses("ararcasına", "aramazcasına", "arıyormuşçasına", "aranılmışçasına",
  ...
  public void Verb2Adverb() {
    ...
    tester.assertHasParses("aramaktansa", "aramamaktansa", "aranmaktansa", "aratmaktansa",
        "aranmamaktansa");
    //AsLongAs_dIkcA
  ...
  public void PresPart_yAn() {
    Tester tester = new Tester("aramak", "gitmek [A:Voicing, Aorist_A]");
    //
    tester.assertHasParses("gidene", "arayandan", "gitmeyenden", "aramayanı", "aratmayanı",
        "aranmayanı");
  }
  ...
  public void FutPart_yAcAK() {
    Tester tester = new Tester("aramak", "gitmek [A:Voicing, Aorist_A]");
    // WithoutDoing_mAdAn
    tester.assertHasParses("gidecekleri", "gitmeyeceklere", "arayacaklardan", "aramayacaklardan",
        "arayamayacaklardan");
  }
  ...
  public void Des() {
    Tester tester = new Tester("aramak", "gitmek [A:Voicing, Aorist_A]");
    tester.assertHasParses("arasa", "arasak", "arasalar", "aramasalar", "aransalar", "aratsalar",
        "arattırsak", "arattırmasanız");
  }
  ...
  public void AgtNoun() {
    Tester tester = new Tester("elma", "armut");
    tester
        .assertHasParses("elmacı", "armutçu", "elmacılar", "elmacısın", "elmacısınız", "elmacıyız",
            "elmacılık");
  }
  ...
  public void stemChange() {
    ...
    tester.assertHasParses("ye", "de", "yeme", "deme", "yiyor", "diyor", "yemiyor", "yiyebilecek",
        "demiyor", "yedi", "dedi");
  ...
  class Tester {
    ...
    void assertUnParseable(String... words) {
      ...
      for (String word : words) {
        List<WordAnalysis> results = parser.analyze(word);
        Assert
            .assertTrue("Unexpected parse for:" + word + " parse:" + results, results.size() == 0);
      }
    }
    ...
    void assertUnParseable(Suffix suffix, String... words) {
      ...
      for (String word : words) {
        ...
        for (WordAnalysis result : results) {
          Assert.assertFalse(
              word + " parse should not contain suffix:" + suffix.id + " parse:" + results,
