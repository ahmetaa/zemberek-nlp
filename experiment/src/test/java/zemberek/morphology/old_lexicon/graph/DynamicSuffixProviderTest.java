...
public class DynamicSuffixProviderTest {
  ...
  public void testNullSets() {
    ...
    NullSuffixForm null1Repeat = provider
        .generateNullFormFromTemplate(tmp1, new SuffixData(set2_2));
  ...
  public void testRegister() {
    ...
    SuffixData constraint = new SuffixData(tmp2.connections).remove(frm1)
        .add(tmp2.indirectConnections);
    ...
    SuffixData constraint2 = new SuffixData(tmp2.connections).remove(frm1)
        .add(tmp2.indirectConnections);
