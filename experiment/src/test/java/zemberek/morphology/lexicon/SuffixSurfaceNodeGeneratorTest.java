...
public class SuffixSurfaceNodeGeneratorTest {
  ...
  public void suffixFormAHarmonyTest() {
    ...
    Assert.assertTrue(surfaceNode.getAttributes()
        .containsAll(Arrays.asList(LastLetterConsonant, LastVowelBack, LastVowelUnrounded)));
  ...
  public void suffixFormIHarmonyTest() {
    SuffixSurfaceNodeGenerator sfg = new SuffixSurfaceNodeGenerator();
    SuffixSurfaceNode form = getFirstNodeNoExpectatios(sfg, set(LastVowelBack, LastVowelUnrounded),
        "sIn");
    Assert.assertEquals("sın", form.surfaceForm);
    Assert.assertTrue(form.getAttributes()
        .containsAll(Arrays.asList(LastLetterConsonant, LastVowelBack, LastVowelUnrounded)));
  ...
  public void emptyFormTest() {
    SuffixSurfaceNodeGenerator sfg = new SuffixSurfaceNodeGenerator();
    SuffixSurfaceNode surfaceNode = getFirstNodeNoExpectatios(sfg,
        set(LastVowelBack, LastVowelRounded, LastLetterConsonant), "");
    Assert.assertEquals("", surfaceNode.surfaceForm);
    Assert.assertTrue(surfaceNode.getAttributes()
        .containsAll(Arrays.asList(LastVowelBack, LastVowelRounded, LastLetterConsonant)));
  }
  ...
  public void novowelFormTest() {
    SuffixSurfaceNodeGenerator sfg = new SuffixSurfaceNodeGenerator();
    SuffixSurfaceNode surfaceNode = getFirstNodeNoExpectatios(sfg,
        set(LastVowelBack, LastVowelRounded, LastLetterVowel), "m");
  ...
  public void lastDevoicingTest() {
    SuffixSurfaceNodeGenerator sfg = new SuffixSurfaceNodeGenerator();
    List<SuffixSurfaceNode> surfaceNodes = getNodes(sfg,
        set(LastVowelBack, LastVowelUnrounded, LastLetterConsonant), ">cI~k");
  ...
  private SuffixSurfaceNode getFirstNodeNoExpectatios(SuffixSurfaceNodeGenerator sfg,
      EnumSet<PhoneticAttribute> attributes, String generation) {
    SuffixForm dummySet = new SuffixForm(1, "dummy-form", new Suffix("dummy"), generation);
    return sfg
        .generate(attributes, EnumSet.noneOf(PhoneticExpectation.class), new SuffixData(), dummySet)
        .get(0);
  }

  private List<SuffixSurfaceNode> getNodes(SuffixSurfaceNodeGenerator sfg,
      EnumSet<PhoneticAttribute> attributes, String generation) {
    SuffixForm dummySet = new SuffixForm(2, "dummy-form", new Suffix("dummy"), generation);
    return sfg.generate(attributes, EnumSet.noneOf(PhoneticExpectation.class), new SuffixData(),
        dummySet);
  }
