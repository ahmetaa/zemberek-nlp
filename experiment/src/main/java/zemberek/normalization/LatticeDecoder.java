...
public class LatticeDecoder {
  ...
  static class ActiveList {
    ...
    /**
     * Adds a new hypothesis to the list. This method does not check for beam pruning. Therefore,
     * before calling this function, checkScore should be called.
     **/
      ...
      public Builder loadFactor(float loadFactor) {
        if (loadFactor < 0.1 || loadFactor > 0.9) {
          throw new IllegalArgumentException(
              "Load factor must be between 0.1 and 0.9. But it is " + loadFactor);
        }
