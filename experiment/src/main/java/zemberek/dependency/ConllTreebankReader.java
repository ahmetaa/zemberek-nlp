...
public class ConllTreebankReader {
  ...
  public static void main(String[] args) throws IOException {
    ...
    List<DependencySentence> testAll = reader
        .readSentences(new File("data/treebank/tr/turkish-metu-sabanci-test.conll"));
    ...
    SimpleTextWriter.oneShotUTF8Writer(new File("data/treebank/tr/turkish-metu-sabanci-test.txt"))
  ...
  public void generateCrossValidationSets(
    ...
    for (int i = 0; i < split; i++) {
      SimpleTextWriter stwTest = SimpleTextWriter
          .keepOpenUTF8Writer(new File(directory, name + "-test-" + i + ".conll"));
      SimpleTextWriter stwTrain = SimpleTextWriter
          .keepOpenUTF8Writer(new File(directory, name + "-train-" + i + ".conll"));
