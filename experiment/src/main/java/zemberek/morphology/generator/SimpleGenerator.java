...
public class SimpleGenerator {
  ...
  public String[] generateMorphemes(DictionaryItem item, List<Suffix> suffixes) {
    ...
    if (tokens.size() == 0) {
      ...
      return tokens.get(0).getAsMorphemes();
    }
  }

  /**
   * generates a word from a dictionary item and a list of Suffixes. There can be multiple results
   * for this operation. Because a suffix can have multiple forms.
   *
