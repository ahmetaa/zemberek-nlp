package zemberek.morphology.old_lexicon.tr;

import zemberek.core.turkish.PrimaryPos;
import zemberek.core.turkish.RootAttribute;
import zemberek.core.turkish.SecondaryPos;
import zemberek.morphology.old_lexicon.DerivationalSuffixTemplate;
import zemberek.morphology.lexicon.DictionaryItem;
import zemberek.morphology.old_lexicon.NullSuffixForm;
import zemberek.morphology.old_lexicon.RootSuffix;
...
import zemberek.morphology.old_lexicon.graph.DynamicSuffixProvider;
...
public class TurkishSuffixes extends DynamicSuffixProvider {
  ...
  public SuffixFormTemplate A3sg_Verb_TEMPLATE = getTemplate("A3sg_Verb_TEMPLATE",
      A3sg); // gel-di-, o-
  ...
  public final SuffixForm[] PERSON_FORMS_N = {A1sg_yIm, A2sg_sIn, A3sg_TEMPLATE, A1pl_yIz,
      A2pl_sInIz, A3pl_lAr};
  public final SuffixForm[] PERSON_FORMS_COP = {A1sg_m, A2sg_n, A3sg_TEMPLATE, A1pl_k, A2pl_nIz,
      A3pl_lAr};
  public SuffixForm A3pl_Verb_lAr_After_Tense = getForm("A3pl_Verb_lAr_After_Tense", A3pl,
      "lAr"); // gel-ecek-ler
  ...
  public SuffixForm Agt_yIcI_2Noun = getForm("Agt_yIcI_2Noun", Agt,
      "+yIcI"); // otur-ucu. converts to both Noun and Adj
  public SuffixForm Agt_yIcI_2Adj = getForm("Agt_yIcI_2Adj", Agt,
      "+yIcI"); // otur-ucu. converts to both Noun and Adj
  ...
  public SuffixFormTemplate Aor_EMPTY = getTemplate("Aor_EMPTY", Aor,
      TerminationType.NON_TERMINAL); // gel-me--yiz
  ...
  public SuffixForm FutPart_yAcAk_2Noun = getForm("FutPart_yAcAk_2Noun", FutPart, "+yAcA~k",
      TerminationType.NON_TERMINAL); // if it is at the end, FutPart only converts to Adj
  public Suffix NarrPart = new Suffix("NarrPart");
  public SuffixForm NarrPart_mIs_2Adj = getForm("NarrPart_mIs_2Adj", NarrPart, "mIş");
  public SuffixForm NarrPart_mIs_2Noun = getForm("NarrPart_mIs_2Noun", NarrPart, "mIş",
  ...
  public SuffixFormTemplate Pos_EMPTY = getTemplate("Pos_EMPTY",
      Pos); // Verb Positive Null Morpheme template.
...
/*    public Suffix Recip = new Suffix("Recip");
  ...
  public final SuffixForm[] COPULAR_FORMS = {Cop_dIr, PastCop_ydI, NarrCop_ymIs, CondCop_ysA,
      While_ken};
  public Suffix Pres = new Suffix(
      "Pres");  // Present tense only appears after a zero morpheme verb derivation such as "kalemdir"
  ...
  public final SuffixForm[] CASE_FORMS = {Nom_TEMPLATE, Dat_yA, Loc_dA, Abl_dAn, Gen_nIn, Acc_yI,
      Inst_ylA, Equ_cA};
...
/*    public Suffix NounDeriv = new Suffix("NounDeriv");
  ...
  public DerivationalSuffixTemplate Noun2Noun = getDerivationalTemplate("Noun2Noun", NounRoot,
      TerminationType.NON_TERMINAL);
  public DerivationalSuffixTemplate Adj2Noun = getDerivationalTemplate("Adj2Noun", NounRoot,
      TerminationType.NON_TERMINAL);
  public DerivationalSuffixTemplate Adv2Noun = getDerivationalTemplate("Adv2Noun", NounRoot,
      TerminationType.NON_TERMINAL);
  public DerivationalSuffixTemplate Verb2Noun = getDerivationalTemplate("Verb2Noun", NounRoot,
      TerminationType.NON_TERMINAL);
  public DerivationalSuffixTemplate Num2Noun = getDerivationalTemplate("Num2Noun", NounRoot,
      TerminationType.NON_TERMINAL);
  public DerivationalSuffixTemplate Verb2NounPart = getDerivationalTemplate("Verb2NounPart",
      NounRoot, TerminationType.NON_TERMINAL);
  ...
  public DerivationalSuffixTemplate Noun2Adj = getDerivationalTemplate("Noun2Adj", AdjRoot,
      TerminationType.NON_TERMINAL);
  public DerivationalSuffixTemplate Adj2Adj = getDerivationalTemplate("Adj2Adj", AdjRoot,
      TerminationType.NON_TERMINAL);
  public DerivationalSuffixTemplate Adv2Adj = getDerivationalTemplate("Adv2Adj", AdjRoot,
      TerminationType.NON_TERMINAL);
  public DerivationalSuffixTemplate Verb2Adj = getDerivationalTemplate("Verb2Adj", AdjRoot,
      TerminationType.NON_TERMINAL);
  public DerivationalSuffixTemplate Verb2AdjPart = getDerivationalTemplate("Verb2AdjPart", AdjRoot,
      TerminationType.NON_TERMINAL);
  public DerivationalSuffixTemplate Num2Adj = getDerivationalTemplate("Num2Adj", AdjRoot,
      TerminationType.NON_TERMINAL);
  public SuffixFormTemplate Adj_Main_Rel = getTemplate("Adj_TEMPLATE", AdjRoot);
  public NullSuffixForm Adj_Default = getNull("Adj_Default", Adj_TEMPLATE,
  ...
  public DerivationalSuffixTemplate Adj2Adv = getDerivationalTemplate("Adj2Adv", AdvRoot,
      TerminationType.NON_TERMINAL);
  public DerivationalSuffixTemplate Verb2Adv = getDerivationalTemplate("Verb2Adv", AdvRoot,
      TerminationType.NON_TERMINAL);
  public DerivationalSuffixTemplate Num2Adv = getDerivationalTemplate("Num2Adv", AdvRoot,
      TerminationType.NON_TERMINAL);
  ...
  public DerivationalSuffixTemplate Postp2Noun = getDerivationalTemplate("Postp2Noun", NounRoot,
      TerminationType.NON_TERMINAL);
  ...
  public DerivationalSuffixTemplate Adj2Verb = getDerivationalTemplate("Adj2Verb", VerbRoot,
      TerminationType.NON_TERMINAL);
  public DerivationalSuffixTemplate Noun2Verb = getDerivationalTemplate("Noun2Verb", VerbRoot,
      TerminationType.NON_TERMINAL);
  public DerivationalSuffixTemplate Noun2VerbCopular = getDerivationalTemplate("Noun2VerbCopular",
      VerbRoot, TerminationType.NON_TERMINAL);
  public DerivationalSuffixTemplate Verb2Verb = getDerivationalTemplate("Verb2Verb", VerbRoot,
      TerminationType.NON_TERMINAL);
  public DerivationalSuffixTemplate Verb2VerbAbility = getDerivationalTemplate("Verb2VerbAbility",
      VerbRoot, TerminationType.NON_TERMINAL);
  public DerivationalSuffixTemplate Verb2VerbCompounds = getDerivationalTemplate(
      "Verb2VerbCompounds", VerbRoot, TerminationType.NON_TERMINAL);
  public DerivationalSuffixTemplate Num2Verb = getDerivationalTemplate("Num2Verb", VerbRoot,
      TerminationType.NON_TERMINAL);
  ...
  public DerivationalSuffixTemplate Pron2Verb = getDerivationalTemplate("Pron2Verb", VerbRoot,
      TerminationType.NON_TERMINAL);
  public SuffixFormTemplate DemonsPron_TEMPLATE = getTemplate("DemonsPron_TEMPLATE",
      DemonsPronRoot);
  public NullSuffixForm DemonsPron_Default = getNull("DemonsPron_Default", DemonsPron_TEMPLATE);
  public SuffixFormTemplate ReflexPron_TEMPLATE = getTemplate("ReflexPron_TEMPLATE",
      ReflexPronRoot);
  ...
  public TurkishSuffixes() {
    ...
    Noun_TEMPLATE.indirectConnections
        ...
        .add(Dim_cIk, Dim2_cAgIz, With_lI, Without_sIz, Agt_cI, JustLike_msI, JustLike_ImsI,
            Ness_lIk, Related_sAl, FitFor_lIk)
    ...
    DemonsPron_TEMPLATE.indirectConnections
        .add(With_lI, Inst_ylA, Without_sIz, Acc_nI, Dat_nA, Loc_ndA, Gen_nIn, Nom_TEMPLATE,
            Abl_ndAn, Cop_dIr, Pron2Verb, PastCop_ydI, NarrCop_ymIs, CondCop_ysA, While_ken,
            A3pl_lAr)
        .add(Pnon_TEMPLATE)
    ...
    Ques_Template.indirectConnections
        .add(Pron2Verb, A3sg_Verb_TEMPLATE, A1pl_yIz, A2pl_sInIz, Pnon_TEMPLATE,
    ...
    Noun2Adj.connections
        .add(With_lI, Without_sIz, JustLike_msI, JustLike_ImsI, Rel_ki, Rel_kI, Related_sAl,
            FitFor_lIk);

    Noun2Verb.connections.add(Become_lAs, Acquire_lAn);

    Noun2VerbCopular.connections
        .add(Pres_TEMPLATE, PastCop_ydI, NarrCop_ymIs, CondCop_ysA, While_ken);
    Noun2VerbCopular.indirectConnections
        .add(A1sg_m, A2sg_n, A3sg_Verb_TEMPLATE, A1pl_k, A2pl_nIz, A3pl_Verb_lAr);
    Noun2VerbCopular.indirectConnections
        .add(A1sg_yIm, A2sg_sIn, A3sg_Verb_TEMPLATE, A1pl_yIz, A2pl_sInIz, Cop_dIr);

    Adj2Noun.connections.add(Noun_TEMPLATE.connections);
    Adj2Noun.indirectConnections.add(Noun_Default.indirectConnections)
        .remove(/*Noun2VerbCopular,*/ FitFor_lIk, Related_sAl, Become_lAs, JustLike_ImsI,
            JustLike_msI, Equ_cA, Equ_ncA);

    //TODO: Too much suffix for Postp.
    Postp2Noun.connections.add(Noun_TEMPLATE.connections);
    Postp2Noun.indirectConnections.add(Noun_Default.indirectConnections)
        .remove(Related_sAl, Become_lAs, JustLike_ImsI, JustLike_msI, Equ_cA, Equ_ncA);
    ...
    Verb2Verb.connections
        .add(Caus_t, Caus_tIr, Pass_In, Pass_nIl, Pass_InIl, Abil_yA/*, Recip_Is, Recip_yIs*/);

    Verb2VerbCompounds.connections
        .add(KeepDoing_yAgor, KeepDoing2_yAdur, EverSince_yAgel, Almost_yAyAz, Hastily_yIver,
            Stay_yAkal, Start_yAkoy);

    Verb2VerbAbility.connections.add(Abil_yAbil);

    Verb2Noun.connections
        .add(Inf1_mAk, Inf2_mA, Inf3_yIs, FeelLike_yAsI_2Noun, Agt_yIcI_2Noun, ActOf_mAcA,
            NotState_mAzlIk);

    Verb2NounPart.connections.add(PastPart_dIk_2Noun, NarrPart_mIs_2Noun, FutPart_yAcAk_2Noun);

    Verb2AdjPart.connections
        .add(PastPart_dIk_2Adj, NarrPart_mIs_2Adj, FutPart_yAcAk_2Adj, AorPart_Ar_2Adj,
            AorPart_Ir_2Adj, AorPart_z_2Adj, PresPart_yAn);
    ...
    Noun_Comp_P3sg_Root.connections.add(A3pl_Comp_lAr,
        A3sg_TEMPLATE); // A3pl_Comp_lAr is used, because zeytinyağ-lar is not allowed.
    Noun_Comp_P3sg_Root.indirectConnections
        .add(Pnon_TEMPLATE, Nom_TEMPLATE, With_lI, Without_sIz, Agt_cI, JustLike_msI, JustLike_ImsI,
            Ness_lIk, Related_sAl)
        .add(P3pl_lArI)
        .add(POSSESSIVE_FORMS)
    ...
    Verb_TEMPLATE.indirectConnections
        .add(Prog_Iyor, Prog2_mAktA, Fut_yAcAk, Past_dI, Narr_mIs, Aor_Ir, Aor_Ar, Aor_z,
            AorPart_Ir_2Adj, AorPart_Ar_2Adj)
        .add(Abil_yAbil, Abil_yA, Caus_tIr, Caus_t, Opt_yA, Imp_TEMPLATE, Agt_yIcI_2Adj,
            Agt_yIcI_2Noun, Des_sA)
        .add(NotState_mAzlIk, ActOf_mAcA, PastPart_dIk_2Adj, PastPart_dIk_2Noun, NarrPart_mIs_2Adj,
            NarrPart_mIs_2Noun, Pass_In, Pass_nIl, Pass_InIl)
        .add(FutPart_yAcAk_2Adj, FutPart_yAcAk_2Noun, PresPart_yAn, AsLongAs_dIkcA, A2pl2_sAnIzA)
        .add(A1sg_yIm, A2sg_sIn, A2sg_TEMPLATE, A3sg_Verb_TEMPLATE, A1pl_yIz, A2pl_yIn, A2pl_sInIz,
            A3pl_Verb_lAr, A3sg_sIn, A3pl_sInlAr, A2sg2_sAnA, A2sg3_yInIz)
        .add(Inf1_mAk, Inf2_mA, Inf3_yIs, Necess_mAlI)
        .add(Cond_sA, Cond_sA_AfterPerson)
        .add(When_yIncA, FeelLike_yAsI_2Adj, FeelLike_yAsI_2Noun, SinceDoing_yAlI, ByDoing_yArAk,
            WithoutDoing_mAdAn, WithoutDoing2_mAksIzIn)
        .add(AfterDoing_yIp, When_yIncA, UnableToDo_yAmAdAn, InsteadOfDoing_mAktAnsA,
            A3pl_Verb_lAr_After_Tense, AsIf_cAsInA)
        .add(KeepDoing2_yAdur, KeepDoing_yAgor, EverSince_yAgel, Almost_yAyAz, Hastily_yIver,
            Stay_yAkal, Start_yAkoy/*, Recip_Is*/)
        .add(UntilDoing_yAsIyA, Verb2VerbCompounds, Verb2Noun, Verb2Adv, Verb2Adj, Verb2NounPart,
            Verb2AdjPart, Verb2VerbAbility);
...
/*        Verb_Reciprocal.connections.add(Verb_Default.connections);
    ...
    Verb_Yi.indirectConnections
        .add(Opt_yA, Fut_yAcAk, FutPart_yAcAk_2Adj, When_yIncA, AfterDoing_yIp, Abil_yA,
            Abil_yAbil/*, Recip_yIs*/, Inf3_yIs, FeelLike_yAsI_2Adj, PresPart_yAn, KeepDoing_yAgor,
            KeepDoing2_yAdur,
            FeelLike_yAsI_2Adj, UnableToDo_yAmAdAn, Verb2Adv, Verb2Adj, Verb2NounPart, Verb2AdjPart,
            Verb2VerbAbility);
    ...
    Verb_De.indirectConnections.add(Verb_Default.indirectConnections)
        .remove(Abil_yA, Abil_yAbil, Prog_Iyor, Fut_yAcAk, FutPart_yAcAk_2Adj, Opt_yA,
            PresPart_yAn, PresPart_yAn, KeepDoing_yAgor, KeepDoing2_yAdur, FeelLike_yAsI_2Adj,
            UnableToDo_yAmAdAn)
        .add(Pass_In);

    Verb_Di.connections.add(Pos_EMPTY, Verb2Verb);
    Verb_Di.indirectConnections
        .add(Opt_yA, Fut_yAcAk, FutPart_yAcAk_2Adj, Abil_yA, Abil_yAbil, PresPart_yAn,
    ...
    A3pl_lAr.connections.add(POSSESSIVE_FORMS).remove(P3pl_lArI).add(P3sg_yI, P3pl_I)
        .remove(P3sg_sI);
    ...
    A3sg_TEMPLATE.connections.add(POSSESSIVE_FORMS)
        .add(P1sg_yIm, P2sg_yIn, P3sg_yI, P1pl_yImIz, P2pl_yInIz);
    ...
    Pres_TEMPLATE.connections
        .add(A1sg_yIm, A2sg_sIn, A3sg_Verb_TEMPLATE, A1pl_yIz, A2pl_sInIz, A3pl_Verb_lAr);
    ...
    Dim_cIk.indirectConnections
        .add(Noun_Default.allConnections().add(Noun2VerbCopular).remove(Dim_cIk, Dim2_cAgIz));

    Agt_cI.connections.add(Noun_Default.connections);
    Agt_cI.indirectConnections.add(
        Noun_Default.allConnections().add(Noun2VerbCopular).add(Noun2VerbCopular.allConnections())
            .remove(Agt_cI));
    ...
    P2sg_In.indirectConnections.add(Noun2VerbCopular).add(Noun2VerbCopular.allConnections())
        .remove(A2sg_sIn, A1pl_yIz, A2pl_nIz, A2pl_sInIz);
    ...
    P3sg_sI.connections
        .add(Nom_TEMPLATE, Dat_nA, Loc_ndA, Abl_ndAn, Gen_nIn, Acc_nI, Inst_ylA, Equ_ncA);
    ...
    Rel_ki.indirectConnections.add(Adj2Noun.indirectConnections)
        .add(A3sg_TEMPLATE, Pnon_TEMPLATE, Dat_nA, Loc_ndA, Abl_ndAn, Gen_nIn, Acc_nI, Inst_ylA,
            Equ_ncA);
    ...
    Become_lAs.indirectConnections.add(Verb_TEMPLATE.indirectConnections)
        .remove(Caus_t, Pass_In, Pass_InIl);
    ...
    Pos_EMPTY.connections
        .add(Verb2VerbCompounds, Verb2Noun, Verb2Adv, Verb2Adj, Verb2AdjPart, Verb2NounPart,
            Verb2VerbAbility,
            Imp_TEMPLATE, Prog_Iyor, Prog2_mAktA, Fut_yAcAk, Aor_Ar, Aor_Ir, Past_dI, Narr_mIs,
            ActOf_mAcA)
    ...
    Neg_mA.connections
        .add(Verb2VerbCompounds, Verb2VerbAbility, Verb2Noun, Verb2Adv, Verb2Adj, Verb2AdjPart,
            Verb2NounPart,
            Aor_z, Aor_EMPTY, Prog2_mAktA, Imp_TEMPLATE, Opt_yA, Des_sA,
            Fut_yAcAk, Past_dI, Narr_mIs, Necess_mAlI, NotState_mAzlIk,
            ActOf_mAcA);

    Neg_mA.indirectConnections
        .add(Verb2VerbCompounds.connections, Verb2AdjPart.connections, Verb2NounPart.connections,
            Verb2Noun.connections, Verb2Adv.connections, Verb2Adj.connections)
        .add(A2sg_TEMPLATE, A1sg_m, A1sg_yIm, A2sg_sIn, A2sg2_sAnA, A2sg3_yInIz, A3sg_Verb_TEMPLATE,
            A1pl_yIz, A2pl_sInIz, A2pl2_sAnIzA, A2pl_yIn, A3pl_Verb_lAr, A3sg_sIn, A3pl_sInlAr)
        .add(Abil_yAbil);

    Neg_m.connections.add(Prog_Iyor);

    Imp_TEMPLATE.connections
        .add(A2sg_TEMPLATE, A2sg2_sAnA, A2sg3_yInIz, A2pl2_sAnIzA, A2pl_yIn, A3sg_sIn, A3pl_sInlAr);

    Caus_t.connections.add(Verb2Verb, Pos_EMPTY, Neg_mA, Neg_m);
    Caus_t.indirectConnections.add(Verb_TEMPLATE.indirectConnections).add(Pass_nIl).add(Caus_tIr)
        .remove(Caus_t);

    Caus_tIr.connections.add(Verb_TEMPLATE.connections);
    Caus_tIr.indirectConnections.add(Verb_TEMPLATE.indirectConnections).add(Pass_nIl).add(Caus_t)
        .remove(Caus_tIr);
...
*/
    ...
    Prog_Iyor.connections
        .add(A3sg_Verb_TEMPLATE, A1sg_yIm, A2sg_sIn, A1pl_yIz, A2pl_sInIz, A3pl_Verb_lAr)
        .add(COPULAR_FORMS);

    Prog2_mAktA.connections
        .add(A3sg_Verb_TEMPLATE, A1sg_yIm, A2sg_sIn, A1pl_yIz, A2pl_sInIz, A3pl_Verb_lAr)
        .add(COPULAR_FORMS);

    Fut_yAcAk.connections
        .add(A3sg_Verb_TEMPLATE, A1sg_yIm, A2sg_sIn, A1pl_yIz, A2pl_sInIz, A3pl_Verb_lAr)
        .add(COPULAR_FORMS);
    ...
    Aor_z.connections.add(A3sg_Verb_TEMPLATE, A3sg_sIn, A2pl_sInIz, A3pl_Verb_lAr)
        .add(PastCop_ydI, NarrCop_ymIs, CondCop_ysA, While_ken, Cop_dIr);
...
/*        FutPart_yAcAk_2Adj.connections.add(Adj2Noun);
    ...
    Past_dI.connections
        .add(A1sg_m, A2sg_n, A3sg_Verb_TEMPLATE, A1pl_k, A2pl_nIz, A3pl_Verb_lAr, CondCop_ysA,
            PastCop_ydI);
    ...
    Cond_sA.connections
        .add(A1sg_m, A2sg_n, A3sg_Verb_TEMPLATE, A1pl_k, A2pl_nIz, A3pl_Verb_lAr, PastCop_ydI,
            NarrCop_ymIs);

    PastCop_ydI.connections.add(PERSON_FORMS_COP);
    NarrCop_ymIs.connections
        .add(A1sg_yIm, A2sg_sIn, A3sg_Verb_TEMPLATE, A1pl_yIz, A2pl_sInIz, A3pl_Verb_lAr);
    ...
    Inf1_mAk.indirectConnections
        .add(Pnon_TEMPLATE, Nom_TEMPLATE, Inst_ylA, Loc_dA, Dat_yA, Abl_dAn, Acc_yI, Noun2Adj,
            Noun2Noun, Noun2VerbCopular);
    Inf1_mAk.indirectConnections.add(Noun2Adj.allConnections(), Noun2Noun.allConnections(),
        Noun2VerbCopular.allConnections());
    Inf1_mAk.indirectConnections
        .remove(Without_sIz); // gelmeksizin only parses with WithoutDoing2(-sizin)
    ...
    KeepDoing_yAgor.indirectConnections
        .add(Pos_EMPTY.indirectConnections, Neg_mA.indirectConnections);

    KeepDoing2_yAdur.connections.add(Pos_EMPTY.connections, Neg_mA.connections);
    KeepDoing2_yAdur.indirectConnections
        .add(Pos_EMPTY.indirectConnections, Neg_mA.indirectConnections);

    EverSince_yAgel.connections.add(Pos_EMPTY.connections, Neg_mA.connections);
    EverSince_yAgel.indirectConnections
        .add(Pos_EMPTY.indirectConnections, Neg_mA.indirectConnections);
    ...
    Hastily_yIver.indirectConnections
        .add(Pos_EMPTY.indirectConnections, Neg_mA.indirectConnections);
    ...
    Necess_mAlI.connections
        .add(A3sg_Verb_TEMPLATE, A1sg_yIm, A2sg_sIn, A1pl_yIz, A2pl_sInIz, A3pl_Verb_lAr)
        .add(COPULAR_FORMS);

    Des_sA.connections
        .add(A1sg_m, A2sg_n, A3sg_TEMPLATE, A1pl_k, A2pl_nIz, A3pl_lAr, PastCop_ydI, NarrCop_ymIs);
    ...
    Opt_yA.connections
        .add(A3sg_Verb_TEMPLATE, A1sg_yIm, A2sg_sIn, A1pl_lIm, A2pl_sInIz, A3pl_Verb_lAr)
        .add(COPULAR_FORMS);

    A1sg_TEMPLATE.connections.add(Pnon_TEMPLATE).remove(POSSESSIVE_FORMS).add(P1sg_Im);
    A1sg_TEMPLATE.indirectConnections.add(CASE_FORMS).add(Pnon_TEMPLATE)
        .add(Noun2Verb, Noun2VerbCopular);
    ...
    A2pl_ler.indirectConnections
        .add(Pnon_TEMPLATE.allConnections().remove(A3pl_Verb_lAr, A3pl_lAr, A3pl_sInlAr));
    ...
    A1pl_ler.indirectConnections
        .add(Pnon_TEMPLATE.allConnections().remove(A3pl_Verb_lAr, A3pl_lAr, A3pl_sInlAr));

    //PersPron_TEMPLATE.connections.add()
    PersPron_TEMPLATE.connections
        .add(A1sg_TEMPLATE, A2sg_TEMPLATE, A3sg_TEMPLATE, A1pl_TEMPLATE, A2pl_TEMPLATE);
    PersPron_TEMPLATE.indirectConnections.add(CASE_FORMS).add(Pnon_TEMPLATE)
        .add(Noun2Verb, Noun2VerbCopular);
    ...
    PersPron_BanSan.indirectConnections.add(PersPron_TEMPLATE.indirectConnections)
        .remove(CASE_FORMS).add(Dat_yA);
    ...
    registerForms(
        Noun_TEMPLATE, Verb_TEMPLATE, Adj_TEMPLATE, Adv_TEMPLATE, Numeral_Template, Postp_Template,
        Dup_Template,
        PersPron_TEMPLATE, DemonsPron_TEMPLATE, ReflexPron_TEMPLATE, Det_Template,
        QuantPron_TEMPLATE,
        ...
        AsIf_cAsInA, AsLongAs_dIkcA, When_yIncA, FeelLike_yAsI_2Adj, FeelLike_yAsI_2Noun,
        SinceDoing_yAlI,
