...
public class StemNode extends MorphNode {
  ...
  public boolean equals(Object o) {
    ...
    if (!surfaceForm.equals(stemNode.surfaceForm)) {
      return false;
    }
    if (!dictionaryItem.equals(stemNode.dictionaryItem)) {
      return false;
    }
    if (!attributes.equals(stemNode.attributes)) {
      return false;
    }
    if (!exclusiveSuffixData.equals(stemNode.exclusiveSuffixData)) {
      return false;
    }
    if (!expectations.equals(stemNode.expectations)) {
      return false;
    }
    if (termination != stemNode.termination) {
      return false;
    }
