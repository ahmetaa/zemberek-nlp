...
public abstract class DynamicSuffixProvider implements SuffixProvider {
  ...
  public DerivationalSuffixTemplate getDerivationalTemplate(String id, Suffix suffix,
      TerminationType type) {
...
/*    public SuffixForm getSuffixFormById(String suffixId) {
  ...
  protected NullSuffixForm generateNullFormFromTemplate(SuffixFormTemplate templateForm,
      SuffixData constraints) {
    ...
    nullForm.indirectConnections = new SuffixData(templateForm.indirectConnections)
        .retain(constraints);
